...
# Загрузка модели ResNet-50 из Keras
model = ResNet50(weights='imagenet')
model.save("resnet50.h5")  # Сохранение модели в файл
...
shape_dict = {"input_1": input_shape}  # Здесь "input_1" - это имя входного слоя модели

# Конвертация модели в Relay формат
